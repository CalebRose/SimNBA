...
func handleRequests() {
	...
	// myRouter.HandleFunc("/admin/transferportal/sync", controller.SyncTransferPortal).Methods("GET")
	...
	// myRouter.HandleFunc("/admin/regress/d", controller.RegressAGamesByOneWeek).Methods("GET")
	...
	// myRouter.HandleFunc("/admin/migrate/international", controller.MoveISLPlayersToDraft).Methods("GET")
	...
	// myRouter.HandleFunc("/generate/new/attributes", controller.GenerateNewAttributes).Methods("GET")
	...
	// myRouter.HandleFunc("/match/fix/isl", controller.FixISLMatchData).Methods("GET")
