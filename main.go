...
func handleRequests() http.Handler {
	...
	// Discord Controls
	apiRouter.HandleFunc("/dis/cbb/player/id/{id}", controller.CBBPlayerByID).Methods("GET")
	apiRouter.HandleFunc("/dis/nba/player/id/{id}", controller.NBAPlayerByID).Methods("GET")
	apiRouter.HandleFunc("/dis/cbb/player/name/{firstName}/{lastName}/{abbr}", controller.CBBPlayerByNameAndAbbr).Methods("GET")
	apiRouter.HandleFunc("/dis/nba/player/name/{firstName}/{lastName}/{abbr}", controller.NBAPlayerByNameAndAbbr).Methods("GET")
	apiRouter.HandleFunc("/dis/cbb/croot/{firstName}/{lastName}", controller.GetCrootsByName).Methods("GET")
	apiRouter.HandleFunc("/dis/cbb/team/{teamId}", controller.GetCollegeTeamData).Methods("GET")
	apiRouter.HandleFunc("/dis/nba/team/{teamId}", controller.GetNBATeamDataByID).Methods("GET")
...
func handleCron() *cron.Cron {
	...
	if runJobs != "FALSE" {
		...
		c.AddFunc("0 16 * * 2,4,6", controller.SyncFreeAgencyOffersViaCron)
	}
