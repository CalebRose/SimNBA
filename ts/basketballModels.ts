...
export class Recruit {
    ...
    constructor(source: any = {}) {
        ...
        this.RecruitProfiles = this.convertValues(source["RecruitProfiles"], PlayerRecruitProfile);
    }
...
export class TeamRecruitingProfile {
    ...
    constructor(source: any = {}) {
        ...
        this.Recruits = this.convertValues(source["Recruits"], PlayerRecruitProfile);
    }
