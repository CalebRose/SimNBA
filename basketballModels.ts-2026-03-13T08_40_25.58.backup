...
export class NBATradeProposalDTO {
    ...
    constructor(source: any = {}) {
        ...
        this.NBATeamTradeOptions = this.convertValues(source["NBATeamTradeOptions"], NBATradeOptionObj);
        this.RecepientTeamTradeOptions = this.convertValues(source["RecepientTeamTradeOptions"], NBATradeOptionObj);
    }
...
export class NBATeamProposals {
    ...
    constructor(source: any = {}) {
        if ('string' === typeof source) source = JSON.parse(source);
        this.SentTradeProposals = this.convertValues(source["SentTradeProposals"], NBATradeProposalDTO);
        this.ReceivedTradeProposals = this.convertValues(source["ReceivedTradeProposals"], NBATradeProposalDTO);
    }
...
export class NBAPlayer {
    ...
    constructor(source: any = {}) {
        ...
        this.Extensions = this.convertValues(source["Extensions"], NBAExtensionOffer);
        this.Contract = this.convertValues(source["Contract"], NBAContract);
        this.Stats = this.convertValues(source["Stats"], NBAPlayerStats);
        this.SeasonStats = this.convertValues(source["SeasonStats"], NBAPlayerSeasonStats);
    }
...
export class Team {
    ...
    constructor(source: any = {}) {
        ...
        this.TeamSeasonStats = this.convertValues(source["TeamSeasonStats"], TeamSeasonStats);
        this.RecruitingProfile = this.convertValues(source["RecruitingProfile"], TeamRecruitingProfile);
    }
...
export class BootstrapData {
    ...
    CapsheetMap: {[key: uint]: NBACapsheet};
    ProRosterMap: {[key: uint]: NBAPlayer[]};
    ...
    TradePreferencesMap: {[key: uint]: NBATradePreferences};
    DraftPicks: DraftPick[];
    ...
    constructor(source: any = {}) {
        ...
        this.PortalPlayers = this.convertValues(source["PortalPlayers"], TransferPlayerResponse);
        this.HistoricCollegePlayers = this.convertValues(source["HistoricCollegePlayers"], HistoricCollegePlayer);
        this.RetiredPlayers = this.convertValues(source["RetiredPlayers"], RetiredPlayer);
        ...
        this.CollegeGameplan = this.convertValues(source["CollegeGameplan"], Gameplan);
        this.TopCBBPoints = this.convertValues(source["TopCBBPoints"], CollegePlayer);
        this.TopCBBAssists = this.convertValues(source["TopCBBAssists"], CollegePlayer);
        this.TopCBBRebounds = this.convertValues(source["TopCBBRebounds"], CollegePlayer);
        ...
        this.ProStandings = this.convertValues(source["ProStandings"], NBAStandings);
        this.CapsheetMap = this.convertValues(source["CapsheetMap"], NBACapsheet, true);
        ...
        this.TradeProposals = this.convertValues(source["TradeProposals"], NBATeamProposals);
        this.TradePreferencesMap = this.convertValues(source["TradePreferencesMap"], NBATradePreferences, true);
        this.DraftPicks = this.convertValues(source["DraftPicks"], DraftPick);
...
export class NBADraftPageResponse {
    ...
    constructor(source: any = {}) {
        ...
        this.DraftablePlayers = this.convertValues(source["DraftablePlayers"], NBADraftee);
...
export class NBATradeProposal {
    ...
    constructor(source: any = {}) {
        ...
        this.NBATeamTradeOptions = this.convertValues(source["NBATeamTradeOptions"], NBATradeOption);
        this.RecepientTeamTradeOptions = this.convertValues(source["RecepientTeamTradeOptions"], NBATradeOption);
    }
...
export class CBBMatchDataResponse {
    ...
    constructor(source: any = {}) {
        ...
        this.HomeTeamRoster = this.convertValues(source["HomeTeamRoster"], CollegePlayer);
        this.HomeTeamGameplan = this.convertValues(source["HomeTeamGameplan"], Gameplan);
        this.AwayTeam = this.convertValues(source["AwayTeam"], MatchTeamResponse);
        this.AwayTeamRoster = this.convertValues(source["AwayTeamRoster"], CollegePlayer);
        this.AwayTeamGameplan = this.convertValues(source["AwayTeamGameplan"], Gameplan);
...
export class MatchResultsResponse {
    ...
    constructor(source: any = {}) {
        if ('string' === typeof source) source = JSON.parse(source);
        this.HomePlayers = this.convertValues(source["HomePlayers"], MatchResultsPlayer);
        this.AwayPlayers = this.convertValues(source["AwayPlayers"], MatchResultsPlayer);
...
export class CollegeTeamResponse {
    ...
    constructor(source: any = {}) {
        ...
        this.IsNBA = source["IsNBA"];
        this.IsActive = source["IsActive"];
        this.SeasonStats = this.convertValues(source["SeasonStats"], TeamSeasonStatsResponse);
...
export class DashboardResponseData {
    ...
    constructor(source: any = {}) {
        ...
        this.NBAStandings = this.convertValues(source["NBAStandings"], NBAStandings);
        this.NBAGames = this.convertValues(source["NBAGames"], NBAMatch);
        this.TopCBBPlayers = this.convertValues(source["TopCBBPlayers"], CollegePlayer);
        this.TopNBAPlayers = this.convertValues(source["TopNBAPlayers"], NBAPlayer);
        this.TopTenPoll = this.convertValues(source["TopTenPoll"], CollegePollOfficial);
        this.CBBTeamStats = this.convertValues(source["CBBTeamStats"], TeamSeasonStats);
        this.NBATeamStats = this.convertValues(source["NBATeamStats"], NBATeamSeasonStats);
    }
...
export class DashboardTeamProfileResponse {
    ...
    constructor(source: any = {}) {
        if ('string' === typeof source) source = JSON.parse(source);
        this.TeamProfile = this.convertValues(source["TeamProfile"], TeamRecruitingProfile);
    }
...
export class GameplanResponse {
    ...
    constructor(source: any = {}) {
        if ('string' === typeof source) source = JSON.parse(source);
        this.Gameplan = this.convertValues(source["Gameplan"], Gameplan);
        this.OpposingRoster = this.convertValues(source["OpposingRoster"], CollegePlayer);
    }
...
export class InboxResponse {
    ...
    constructor(source: any = {}) {
        if ('string' === typeof source) source = JSON.parse(source);
        this.CBBNotifications = this.convertValues(source["CBBNotifications"], Notification);
        this.NBANotifications = this.convertValues(source["NBANotifications"], Notification);
    }
